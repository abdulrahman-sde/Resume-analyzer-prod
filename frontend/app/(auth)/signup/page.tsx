...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-[#050505]">
      {/* Background Ambience */}
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-purple-500/10 blur-[100px] rounded-full mix-blend-screen pointer-events-none" />
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-indigo-500/10 blur-[100px] rounded-full mix-blend-screen pointer-events-none" />
      ...
      <div className="w-full max-w-md p-8 relative z-10 my-10">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Join Synapse</h1>
          <p className="text-white/40">Initialize your recruiting workspace</p>
        </div>
